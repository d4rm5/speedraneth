...
contract DEX {
	...
	function price(
		...
		return
			(xInputWithFee * yReserves) / ((xReserves * 1000) + xInputWithFee);
	}
	...
	function ethToToken() public payable returns (uint256 tokenOutput) {
		require(msg.value > 0, "Amount to swap can't be zero.");
	...
	function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
		require(tokenInput > 0, "Amount to swap can't be zero.");
	...
	function deposit() public payable returns (uint256 tokensDeposited) {
		...
		// 💡 added 1 wei at end of calculation   ^
	...
	function withdraw(
		...
		require(
			...
			"Withdraw amount can't be superior to liquidity provided"
		);
